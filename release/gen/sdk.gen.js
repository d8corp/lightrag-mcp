...
var zod_gen = require('./zod.gen.js');
 ...
 */
const scanForNewDocumentsDocumentsScanPost = (options) => (options?.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zScanForNewDocumentsDocumentsScanPostResponse.parseAsync(data),
 ...
 */
const uploadToInputDirDocumentsUploadPost = (options) => (options.client ?? client_gen.client).post({
    ...bodySerializer_gen.formDataBodySerializer,
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zUploadToInputDirDocumentsUploadPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zUploadToInputDirDocumentsUploadPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const insertTextDocumentsTextPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zInsertTextDocumentsTextPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zInsertTextDocumentsTextPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/documents/text',
    ...options,
    headers: {
 ...
 * HTTPException: If an error occurs during text processing (500).
 */
const insertTextsDocumentsTextsPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zInsertTextsDocumentsTextsPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zInsertTextsDocumentsTextsPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/documents/texts',
    ...options,
    headers: {
 ...
 */
const clearDocumentsDocumentsDelete = (options) => (options?.client ?? client_gen.client).delete({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zClearDocumentsDocumentsDeleteResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/documents',
    ...options
});
 ...
 */
const documentsDocumentsGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zDocumentsDocumentsGetResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/documents',
    ...options
});
 ...
 */
const getPipelineStatusDocumentsPipelineStatusGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zGetPipelineStatusDocumentsPipelineStatusGetResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const deleteDocumentDocumentsDeleteDocumentDelete = (options) => (options.client ?? client_gen.client).delete({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zDeleteDocumentDocumentsDeleteDocumentDeleteBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zDeleteDocumentDocumentsDeleteDocumentDeleteResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const clearCacheDocumentsClearCachePost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zClearCacheDocumentsClearCachePostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zClearCacheDocumentsClearCachePostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const deleteEntityDocumentsDeleteEntityDelete = (options) => (options.client ?? client_gen.client).delete({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zDeleteEntityDocumentsDeleteEntityDeleteBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zDeleteEntityDocumentsDeleteEntityDeleteResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const deleteRelationDocumentsDeleteRelationDelete = (options) => (options.client ?? client_gen.client).delete({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zDeleteRelationDocumentsDeleteRelationDeleteBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zDeleteRelationDocumentsDeleteRelationDeleteResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const getTrackStatusDocumentsTrackStatusTrackIdGet = (options) => (options.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: zod_gen.zGetTrackStatusDocumentsTrackStatusTrackIdGetPath,
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zGetTrackStatusDocumentsTrackStatusTrackIdGetResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const getDocumentsPaginatedDocumentsPaginatedPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zGetDocumentsPaginatedDocumentsPaginatedPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zGetDocumentsPaginatedDocumentsPaginatedPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const getDocumentStatusCountsDocumentsStatusCountsGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zGetDocumentStatusCountsDocumentsStatusCountsGetResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const reprocessFailedDocumentsDocumentsReprocessFailedPost = (options) => (options?.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zReprocessFailedDocumentsDocumentsReprocessFailedPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const cancelPipelineDocumentsCancelPipelinePost = (options) => (options?.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zCancelPipelineDocumentsCancelPipelinePostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const queryTextQueryPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zQueryTextQueryPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zQueryTextQueryPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/query',
    ...options,
    headers: {
 ...
 */
const queryTextStreamQueryStreamPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zQueryTextStreamQueryStreamPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const queryDataQueryDataPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zQueryDataQueryDataPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zod_gen.zQueryDataQueryDataPostResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/query/data',
    ...options,
    headers: {
 ...
 */
const getGraphLabelsGraphLabelListGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const getPopularLabelsGraphLabelPopularGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: zod_gen.zGetPopularLabelsGraphLabelPopularGetQuery.optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const searchLabelsGraphLabelSearchGet = (options) => (options.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: zod_gen.zSearchLabelsGraphLabelSearchGetQuery
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const getKnowledgeGraphGraphsGet = (options) => (options.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: zod_gen.zGetKnowledgeGraphGraphsGetQuery
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
    url: '/graphs',
    ...options
 ...
 */
const checkEntityExistsGraphEntityExistsGet = (options) => (options.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: zod_gen.zCheckEntityExistsGraphEntityExistsGetQuery
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 * }
 */
const updateEntityGraphEntityEditPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zUpdateEntityGraphEntityEditPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const updateRelationGraphRelationEditPost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zUpdateRelationGraphRelationEditPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 * }
 */
const createEntityGraphEntityCreatePost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zCreateEntityGraphEntityCreatePostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 * }
 */
const createRelationGraphRelationCreatePost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zCreateRelationGraphRelationCreatePostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const mergeEntitiesGraphEntitiesMergePost = (options) => (options.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zMergeEntitiesGraphEntitiesMergePostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }, { name: 'X-API-Key', type: 'apiKey' }],
 ...
 */
const getVersionApiVersionGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const getTagsApiTagsGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const getRunningModelsApiPsGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const generateApiGeneratePost = (options) => (options?.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 * Supports both application/json and application/octet-stream Content-Types.
 */
const chatApiChatPost = (options) => (options?.client ?? client_gen.client).post({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const redirectToWebuiGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 */
const getAuthStatusAuthStatusGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
 ...
 * Login
 */
const loginLoginPost = (options) => (options.client ?? client_gen.client).post({
    ...bodySerializer_gen.urlSearchParamsBodySerializer,
    requestValidator: async (data) => await z__namespace.object({
        body: zod_gen.zLoginLoginPostBody,
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
    }).parseAsync(data),
    url: '/login',
 ...
 */
const getStatusHealthGet = (options) => (options?.client ?? client_gen.client).get({
    requestValidator: async (data) => await z__namespace.object({
        body: z__namespace.never().optional(),
        path: z__namespace.never().optional(),
        query: z__namespace.never().optional()
...
exports.cancelPipelineDocumentsCancelPipelinePost = cancelPipelineDocumentsCancelPipelinePost;
exports.chatApiChatPost = chatApiChatPost;
exports.checkEntityExistsGraphEntityExistsGet = checkEntityExistsGraphEntityExistsGet;
exports.clearCacheDocumentsClearCachePost = clearCacheDocumentsClearCachePost;
exports.clearDocumentsDocumentsDelete = clearDocumentsDocumentsDelete;
exports.createEntityGraphEntityCreatePost = createEntityGraphEntityCreatePost;
exports.createRelationGraphRelationCreatePost = createRelationGraphRelationCreatePost;
exports.deleteDocumentDocumentsDeleteDocumentDelete = deleteDocumentDocumentsDeleteDocumentDelete;
exports.deleteEntityDocumentsDeleteEntityDelete = deleteEntityDocumentsDeleteEntityDelete;
exports.deleteRelationDocumentsDeleteRelationDelete = deleteRelationDocumentsDeleteRelationDelete;
exports.documentsDocumentsGet = documentsDocumentsGet;
exports.generateApiGeneratePost = generateApiGeneratePost;
exports.getAuthStatusAuthStatusGet = getAuthStatusAuthStatusGet;
exports.getDocumentStatusCountsDocumentsStatusCountsGet = getDocumentStatusCountsDocumentsStatusCountsGet;
exports.getDocumentsPaginatedDocumentsPaginatedPost = getDocumentsPaginatedDocumentsPaginatedPost;
exports.getGraphLabelsGraphLabelListGet = getGraphLabelsGraphLabelListGet;
exports.getKnowledgeGraphGraphsGet = getKnowledgeGraphGraphsGet;
exports.getPipelineStatusDocumentsPipelineStatusGet = getPipelineStatusDocumentsPipelineStatusGet;
exports.getPopularLabelsGraphLabelPopularGet = getPopularLabelsGraphLabelPopularGet;
exports.getRunningModelsApiPsGet = getRunningModelsApiPsGet;
exports.getStatusHealthGet = getStatusHealthGet;
exports.getTagsApiTagsGet = getTagsApiTagsGet;
exports.getTrackStatusDocumentsTrackStatusTrackIdGet = getTrackStatusDocumentsTrackStatusTrackIdGet;
exports.getVersionApiVersionGet = getVersionApiVersionGet;
exports.insertTextDocumentsTextPost = insertTextDocumentsTextPost;
exports.insertTextsDocumentsTextsPost = insertTextsDocumentsTextsPost;
exports.loginLoginPost = loginLoginPost;
exports.mergeEntitiesGraphEntitiesMergePost = mergeEntitiesGraphEntitiesMergePost;
exports.queryDataQueryDataPost = queryDataQueryDataPost;
exports.queryTextQueryPost = queryTextQueryPost;
exports.queryTextStreamQueryStreamPost = queryTextStreamQueryStreamPost;
exports.redirectToWebuiGet = redirectToWebuiGet;
exports.reprocessFailedDocumentsDocumentsReprocessFailedPost = reprocessFailedDocumentsDocumentsReprocessFailedPost;
exports.scanForNewDocumentsDocumentsScanPost = scanForNewDocumentsDocumentsScanPost;
exports.searchLabelsGraphLabelSearchGet = searchLabelsGraphLabelSearchGet;
exports.updateEntityGraphEntityEditPost = updateEntityGraphEntityEditPost;
exports.updateRelationGraphRelationEditPost = updateRelationGraphRelationEditPost;
exports.uploadToInputDirDocumentsUploadPost = uploadToInputDirDocumentsUploadPost;
