...
import '../gen/index.mjs';
import '../gen/client/index.mjs';
import { zInsertTextRequest, zQueryRequest, zInsertTextsRequest, zDocumentsRequest, zDeleteDocRequest, zEntityCreateRequest, zEntityUpdateRequest, zDeleteEntityRequest, zEntityMergeRequest, zRelationCreateRequest, zRelationUpdateRequest, zDeleteRelationRequest, zClearCacheRequest, zGetTrackStatusDocumentsTrackStatusTrackIdGetPath, zGetPopularLabelsGraphLabelPopularGetQuery, zSearchLabelsGraphLabelSearchGetQuery, zGetKnowledgeGraphGraphsGetQuery, zCheckEntityExistsGraphEntityExistsGetQuery } from '../gen/zod.gen.mjs';
import { createClient } from '../gen/client/client.gen.mjs';
import { createConfig } from '../gen/client/utils.gen.mjs';
import { insertTextDocumentsTextPost, queryTextQueryPost, insertTextsDocumentsTextsPost, getDocumentsPaginatedDocumentsPaginatedPost, deleteDocumentDocumentsDeleteDocumentDelete, queryDataQueryDataPost, createEntityGraphEntityCreatePost, updateEntityGraphEntityEditPost, deleteEntityDocumentsDeleteEntityDelete, mergeEntitiesGraphEntitiesMergePost, createRelationGraphRelationCreatePost, updateRelationGraphRelationEditPost, deleteRelationDocumentsDeleteRelationDelete, clearCacheDocumentsClearCachePost, scanForNewDocumentsDocumentsScanPost, getDocumentStatusCountsDocumentsStatusCountsGet, clearDocumentsDocumentsDelete, reprocessFailedDocumentsDocumentsReprocessFailedPost, getPipelineStatusDocumentsPipelineStatusGet, cancelPipelineDocumentsCancelPipelinePost, getGraphLabelsGraphLabelListGet, getTrackStatusDocumentsTrackStatusTrackIdGet, getPopularLabelsGraphLabelPopularGet, searchLabelsGraphLabelSearchGet, getKnowledgeGraphGraphsGet, checkEntityExistsGraphEntityExistsGet } from '../gen/sdk.gen.mjs';
